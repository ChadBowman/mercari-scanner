...
class MercariSpider(scrapy.Spider):
    ...
    def _build_url(self):
        keyword = 'keyword=' + self.settings.get('mercari.keyword')
        min_price = 'minPrice=' + self.settings.get('mercari.min_price')
        max_price = 'maxPrice=' + self.settings.get('mercari.max_price')
